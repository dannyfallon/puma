...
#line 75 "ext/puma_http11/http11_parser.rl"
...
st14:
	if ( ++p == pe )
		goto _test_eof14;
case 14:
#line 311 "ext/puma_http11/http11_parser.c"
	if ( (*p) == 10 )
		goto st15;
	goto st0;
st15:
...
st47:
	if ( ++p == pe )
		goto _test_eof47;
case 47:
#line 362 "ext/puma_http11/http11_parser.c"
	goto st0;
tr21:
...
st17:
	if ( ++p == pe )
		goto _test_eof17;
case 17:
#line 378 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 33: goto tr23;
		case 58: goto tr24;
		case 124: goto tr23;
...
st18:
	if ( ++p == pe )
		goto _test_eof18;
case 18:
#line 417 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 13: goto tr26;
		case 32: goto tr27;
	}
...
st19:
	if ( ++p == pe )
		goto _test_eof19;
case 19:
#line 431 "ext/puma_http11/http11_parser.c"
	if ( (*p) == 13 )
		goto tr29;
	goto st19;
tr9:
...
st20:
	if ( ++p == pe )
		goto _test_eof20;
case 20:
#line 477 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr31;
		case 60: goto st0;
		case 62: goto st0;
...
st21:
	if ( ++p == pe )
		goto _test_eof21;
case 21:
#line 498 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr33;
		case 60: goto st0;
		case 62: goto st0;
...
st22:
	if ( ++p == pe )
		goto _test_eof22;
case 22:
#line 519 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 43: goto st22;
		case 58: goto st23;
	}
...
st23:
	if ( ++p == pe )
		goto _test_eof23;
case 23:
#line 544 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr8;
		case 34: goto st0;
		case 35: goto tr9;
...
st24:
	if ( ++p == pe )
		goto _test_eof24;
case 24:
#line 564 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr37;
		case 34: goto st0;
		case 35: goto tr38;
...
#line 111 "ext/puma_http11/http11_parser.rl"
